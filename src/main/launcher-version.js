...
const LauncherVersion = {
  ...
  name: 'Velkora Client',
  version: '4.4.3', // Format: MAJOR.MINOR.PATCH
  versionName: '4.4.3', // Format: Nom de la version
  build: '20260708', // Format: YYYYMMDD
  releaseDate: '2026-07-08', // Format: YYYY-MM-DD
