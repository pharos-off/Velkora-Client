...
const LauncherVersion = {
  ...
  name: 'Velkora Client',
  version: '4.3.4', // Format: MAJOR.MINOR.PATCH
  versionName: '4.3.4', // Format: Nom de la version
  build: '20260625', // Format: YYYYMMDD
  releaseDate: '2026-06-25', // Format: YYYY-MM-DD
